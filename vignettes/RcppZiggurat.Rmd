...
\begin{figure*}[!tp]
  ...
  \begin{minipage}{0.475\textwidth}
    \begin{center}
      ...
      \caption{Ziggurant and R Normal RNG Generator Performance 
...
\begin{figure}[!tp]
  ...
  \end{center}
\end{figure}
FIXME \ caption{Ziggurant and R Normal RNG Generator Performance \label{fig:ZiggRNormalRNGs}}-->
...
The remainder of code segment shows how two functions
